...
const required = [
  ...
  ".env.example",
  "README.md",
  "4_党群工作部_党务工作智能问答助手_PRD.md",
  "4_党群工作部_党务工作智能问答助手_MVP需求拆解.md",
];
...
for (const text of ["users", "audit-logs", "settings", "systemRoutes", "console-menu-divider"]) {
...
console.log("党务智答中枢 structure verification passed.");
